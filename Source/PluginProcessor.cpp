...
{
    // get the value of the middle peak filter
...
{
    //set value of the lowhCut filter
...
{
    //set value of the highCut filter
...
juce::AudioProcessorValueTreeState::ParameterLayout  SimpleEQAudioProcessor::createParameterLayout()
{
    /* the skewed value is set 0.25f
     (which left 0.75 of the slider is for 20-10000hz and the right 0.25f for 10000-20000Hz
     because we hear octave change when frequency double
     e.g. A = 220, 440, 880
     which the values goes up slow even when the frequency is doubled)
    */
